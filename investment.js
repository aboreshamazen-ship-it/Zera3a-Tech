...
function showSubsectionDetails(subsectionId) {
    ...
    const detailsHTML = `
        <div class="subsection-header">
            ...
            <button class="close-details" onclick="closeSubsectionDetails('${containerId}')" data-translate="details.close">
        ...
        <div class="subsection-content">
            <div class="subsection-info">
                ...
                <h4 data-translate="details.features">
                ...
                <h4 data-translate="details.statistics">
                ...
                <div class="subsection-stats">
                    ...
                    <div class="subsection-stat">
                        ...
                        <span class="subsection-stat-label" data-translate="details.minimumInvestment">
            ...
            <div class="modern-form compact-form">
                ...
                <form onsubmit="submitInvestmentForm(event, '${subsectionId}')" id="investment-form-${subsectionId}">
                    <div class="form-group-modern">
                        <label class="form-label-modern">
                            ...
                            <span data-translate="form.fullName">${isEnglishMode ? 'Full Name' : 'الاسم الكامل'}</span> *
                        </label>
                    ...
                    <div class="form-row-modern">
                        <div class="form-group-modern">
                            <label class="form-label-modern">
                                ...
                                <span data-translate="form.phone">${isEnglishMode ? 'Phone Number' : 'رقم الهاتف'}</span> *
                            </label>
                        ...
                        <div class="form-group-modern">
                            <label class="form-label-modern">
                                ...
                                <span data-translate="form.email">${isEnglishMode ? 'Email Address' : 'البريد الإلكتروني'}</span> *
                            </label>
                    ...
                    <div class="form-row-modern">
                        <div class="form-group-modern">
                            <label class="form-label-modern">
                                ...
                                <span data-translate="form.userType">${isEnglishMode ? 'User Type' : 'نوع المستخدم'}</span> *
                            </label>
                        ...
                        <div class="form-group-modern">
                            <label class="form-label-modern">
                                ...
                                <span data-translate="form.investmentAmount">${isEnglishMode ? 'Investment Amount' : 'مبلغ الاستثمار'}</span> *
                            </label>
                    ...
                    <div class="form-group-modern">
                        <label class="form-label-modern">
                            ...
                            <span data-translate="form.message">${isEnglishMode ? 'Additional Message' : 'رسالة إضافية'}</span>
                        </label>
                    ...
                    <div class="form-actions-modern">
                        <button type="button" class="btn-modern btn-secondary-modern" onclick="closeSubsectionDetails('${containerId}')">
                            <i class="fas fa-times"></i>
                            <span data-translate="form.cancel">${isEnglishMode ? 'Cancel' : 'إلغاء'}</span>
                        </button>
                        <button type="submit" class="btn-modern btn-primary-modern">
                            <i class="fas fa-paper-plane"></i>
                            <span data-translate="form.submit">${isEnglishMode ? 'Submit Request' : 'إرسال الطلب'}</span>
                        </button>
                    </div>
                </form>
                <!-- رسالة النجاح -->
                <div class="success-message" id="success-message-${subsectionId}">
                    ...
                    <h4 data-translate="form.success.title">${isEnglishMode ? 'Request Submitted Successfully!' : 'تم تقديم الطلب بنجاح!'}</h4>
                    <p data-translate="form.success.message">${translateText('form.success.message')}</p>
                </div>
            </div>
        </div>
    `;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.addEventListener('click', function(event) {
        ...
        if (navContent && mobileMenuBtn && 
            !navContent.contains(event.target) && !mobileMenuBtn.contains(event.target)) {
            closeMobileMenu();
        }
    });
    ...
    document.querySelectorAll('.invest-btn').forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            const subsectionId = onclickAttr.match(/'([^']+)'/)[1];
            showSubsectionDetails(subsectionId);
        });
    });
